-- ═══════════════════════════════════════════════════════════════════════════
-- FORMATAÇÃO: Textos das questões ENEM 2025 formatados como na prova original
-- Execute cada UPDATE separadamente no Supabase SQL Editor
-- ═══════════════════════════════════════════════════════════════════════════

-- ═══════════════════════════════════════════════════════════════════════════
-- QUESTÕES 6-10: Crônica "De próprio punho" - Formatada como na prova
-- ═══════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════
-- QUESTÃO 5 (Inglês): Imagem dos copos de café - Descrição visual
-- ═══════════════════════════════════════════════════════════════════════════

UPDATE questoes_enem
SET contexto = '[Imagem: Três copos de café em tamanhos diferentes, dispostos lado a lado em uma cafeteria. Cada copo possui uma etiqueta com uma frase em inglês:]

**Copo pequeno (12 oz):** "I slept great"
**Copo médio (16 oz):** "I slept okay"
**Copo grande (20 oz):** "What is sleep?"
...
-- ═══════════════════════════════════════════════════════════════════════════
-- QUESTÃO 14: Cartaz publicitário da Bienal do Livro
-- ═══════════════════════════════════════════════════════════════════════════

UPDATE questoes_enem
SET contexto = '[Cartaz publicitário da 26ª Bienal Internacional do Livro de São Paulo]

**"Você entra Fernando.**
**E sai Pessoa."**

[Ilustração de um jovem com a cabeça e a camiseta preenchidas por símbolos de Portugal: bondinho, caravela e elementos típicos portugueses]
...
-- ═══════════════════════════════════════════════════════════════════════════
-- QUESTÃO 24: Cartaz UNICEF sobre racismo
-- ═══════════════════════════════════════════════════════════════════════════

UPDATE questoes_enem
SET contexto = '[Cartaz de campanha da UNICEF Brasil]

[Imagem de duas crianças lado a lado:]

**Criança branca:** "Quando crescer, quero ser médico"
**Criança negra:** "Quando crescer, quero estar vivo"
...
UPDATE questoes_enem
SET contexto = '[Cartaz informativo do TJDFT - Tribunal de Justiça do Distrito Federal e dos Territórios]

**Campanha de conscientização sobre violência escolar**

[Infográfico com dados estatísticos sobre violência contra meninas no ambiente escolar, destacando a necessidade de políticas públicas para proteção e segurança das estudantes]
...
-- ═══════════════════════════════════════════════════════════════════════════
-- QUESTÃO 34: Capa da Revista Galileu
-- ═══════════════════════════════════════════════════════════════════════════

UPDATE questoes_enem
SET contexto = '[Capa da Revista Galileu]

**VOCÊ (NÃO) ESTÁ SOZINHO**

[Ilustração de uma pessoa cercada por ícones de redes sociais, notificações e símbolos de conectividade digital, sugerindo a contradição entre hiperconectividade e solidão]
...
SELECT numero_questao, LEFT(contexto, 150) as preview
FROM questoes_enem
WHERE ano_prova = 2025
